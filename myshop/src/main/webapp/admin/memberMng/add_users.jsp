...
<span class="action-span1"><a href="../index.jsp">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 添加会员 </span>
...
<div id="footer">
共执行 3 个查询，用时 0.010337 秒，Gzip 已禁用，内存占用 1.933 MB<br>
