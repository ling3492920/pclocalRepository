...
<h1>
<span class="action-span"><a href="admin_lst.jsp">管理员列表</a></span>
<span class="action-span1"><a href="../index.jsp">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 添加管理员 </span>
<div style="clear:both"></div>
</h1>
<div class="main-div">
<form name="theForm" method="post" action="${baseurl }auser/add.do" onsubmit="return validate();">
<table width="100%">
  <tbody><tr>
