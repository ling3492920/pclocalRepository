...
$(function(){
	$.ajax({
		url:"${baseurl}auser/checkMenus.do",
		type:"get",
		dataType:"json",
		success:function(res){
			if(res.state==0){
				...
				var auas = res.data;
				console.log(auas.length)
				for(var i=0;i<auas.length;i++){				
					var li='<li class="collapse" key="04_order" name="menu">'+auas.action_code;
						var au = auas[i].aus;  
						
						for(var j=0;j<au.length;j++){
							li+='<ul style="display: none;">'+
						      '<li class="menu-item"><a href="orderMng/order_lst.jsp" target="main-frame">'+au.action_code+'</a></li>'+    
									'</ul>';
						}
					li+='</li>';
					$("#menus").append(li);
...
<ul id="menus">   
  <li class="collapse" key="04_order" name="menu">
    订单管理        
    <ul style="display: none;">
          <li class="menu-item"><a href="orderMng/order_lst.jsp" target="main-frame">订单列表</a></li>    
    </ul>
  </li>
     
     <shiro:hasPermission name="users_manage">
  <li class="collapse" key="08_members" name="menu">
    会员管理        <ul style="display: none;">
          <li class="menu-item"><a href="templates/user_list.jsp" target="main-frame">会员列表</a></li>
          <li class="menu-item"><a href="memberMng/add_users.jsp" target="main-frame">添加会员</a></li>
          <li class="menu-item"><a href="memberMng/user_rank.jsp" target="main-frame">会员等级</a></li>
          
        </ul>
      </li>
      </shiro:hasPermission> 
      
  <li class="collapse" key="10_priv_admin" name="menu">
    权限管理        <ul style="display: none;">
          <li class="menu-item"><a href="powerMng/admin_lst.jsp" target="main-frame">管理员列表</a></li>
          
          <li class="menu-item"><a href="powerMng/admin_log.jsp" target="main-frame">管理员日志</a></li>
          <li class="menu-item"><a href="powerMng/roleMng.jsp" target="main-frame">角色管理</a></li>
        </ul>
      </li>
      
  <li class="collapse" key="11_system" name="menu">
    系统设置        <ul style="display: none;">
    	
          <li class="menu-item"><a href="templates/shopconfig.jsp" target="main-frame">商店设置</a></li>
