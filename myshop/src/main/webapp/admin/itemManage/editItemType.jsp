...
<h1>
<span class="action-span"><a href="itemType.jsp">商品分类</a></span>
<span class="action-span1"><a href="#">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 编辑商品分类 </span>
      ...
      <form enctype="multipart/form-data" action="" method="post" name="theForm" onsubmit="return validate();">
        ...
        <option value="1">北京供货商</option><option value="2">上海供货商</option>      </select></td>
          ...
          <tr id="auto_thumb_1">
            ...
            <td id="auto_thumb_3">
              ...
              <input type="file" size="35" ><img src="../images/no.gif"><br>
              <!--  由于这里逻辑不清（可能存在影响提交表单的情况）暂时不用
              <input type="text" size="40" value="商品缩略图外部URL" style="color:#aaa;" onfocus="if (this.value == '商品缩略图外部URL'){this.value='http://';this.style.color='#000';}" name="goods_thumb_url" disabled=""><br>
              <label for="auto_thumb">
              <input type="checkbox" id="auto_thumb" name="auto_thumb" checked="true" value="1" onclick="handleAutoThumb(this.checked)">自动生成商品缩略图</label>
			  -->
			</td>
          </tr>
        ...
        <table width="90%" id="detail-table" style="display:none">
          <tbody><tr>
            ...
            <iframe id="goods_desc___Frame" src="goods_desc.jsp" width="100%" height="320" frameborder="0" scrolling="no" style="margin: 0px; padding: 0px; border: 0px; width: 100%; height: 320px; background-image: none; background-color: transparent;"></iframe>
            </td>
          </tr>
        </tbody></table>
