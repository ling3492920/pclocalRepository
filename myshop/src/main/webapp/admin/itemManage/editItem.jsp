...
$(function(){
    $("#cat").val('${goods.cat_id}');
    $("#brand_id").val("${goods.brand_id}")
})
</script>
</head>
<body>
...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form enctype="multipart/form-data" action="${baseurl }agoods/edit.do" method="post" >
      	<input type="hidden" name="goods_id" value="${goods.goods_id }"></input>
        <!-- 最大文件限制 -->
        ...
        <table width="90%" id="mix-table" style="display:none" align="center">
          ...
          <tr>
            ...
            <td><input type="checkbox" name="is_best" value="${goods.is_best }" checked="${goods.is_best }==1?true:false">精品 <input type="checkbox" name="is_new" value="${goods.is_new }" checked="${goods.is_new }==1?true:false">新品 <input type="checkbox" name="is_hot" value="${goods.is_hot }" checked="${goods.is_hot }==1?true:false">热销</td>
          </tr>
          <tr id="alone_sale_1">
            <td class="label" id="alone_sale_2">上架：</td>
            <td id="alone_sale_3"><input type="checkbox" name="is_on_sale" value="${goods.is_on_sale }" checked="checked"> 打勾表示允许销售，否则不允许销售。</td>
          </tr>
          <tr>
            <td class="label">能作为普通商品销售：</td>
            <td><input type="checkbox" name="is_alone_sale" value="${goods.is_alone_sale }" checked="checked"> 打勾表示能作为普通商品销售，否则只能作为配件或赠品销售。</td>
          </tr>
          <tr>
            <td class="label">是否为免运费商品</td>
            <td><input type="checkbox" name="is_shipping" value="${goods.is_shipping }"> 打勾表示此商品不会产生运费花销，否则按照正常运费计算。</td>
          </tr>
          <tr>
