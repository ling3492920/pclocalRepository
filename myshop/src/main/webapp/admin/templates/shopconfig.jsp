...
<script type="text/javascript" src="../js/utils.js"></script><script type="text/javascript" src="../js/region.js"></script><div class="tab-div">
  <!-- tab bar -->
  <div id="tabbar-div">
    <p>
  ...
  <div id="tabbody-div">
    <form enctype="multipart/form-data" name="theForm" action="?act=post" method="post">
        <table width="90%" id="shop_info-table" style="display: table;">
            <tbody><tr>
        ...
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeshop_title');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    商店标题:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeqq');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    客服QQ号码:
        </td>
        <td>
          ...
          <span class="notice-span" style="display:block" id="noticeqq">如果您有多个客服的QQ号码，请在每个号码之间使用半角逗号（,）分隔。</span>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeww');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    淘宝旺旺:
        </td>
        <td>
          ...
          <span class="notice-span" style="display:block" id="noticeww">如果您有多个客服的淘宝旺旺号码，请在每个号码之间使用半角逗号（,）分隔。</span>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeskype');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    Skype:
        </td>
        <td>
          ...
          <span class="notice-span" style="display:block" id="noticeskype">如果您有多个客服的Skype号码，请在每个号码之间使用半角逗号（,）分隔。提示：你需要在你的Skype隐私设置中启用状态显示功能</span>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeym');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    Yahoo Messenger:
        </td>
        <td>
          ...
          <span class="notice-span" style="display:block" id="noticeym">如果您有多个客服的 Yahoo Messenger 号码，请在每个号码之间使用半角逗号（,）分隔。</span>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticemsn');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    MSN Messenger:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeshop_logo');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    商店 Logo:
        </td>
        <td>
        ...
        <td>
                              <label for="value_119_0"><input type="radio" name="value[119]" id="value_119_0" value="0" checked="true">否</label>
                    <label for="value_119_1"><input type="radio" name="value[119]" id="value_119_1" value="1">是</label>
          
                            </td>
      </tr>
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeuser_notice');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    用户中心公告:
        </td>
        <td>
          ...
          <span class="notice-span" style="display:block" id="noticeuser_notice">该信息将在用户中心欢迎页面显示</span>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeshop_notice');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    商店公告:
        </td>
        <td>
...
&lt;P&gt;咨询电话010-10124444  010-21252454 8465544&lt;/P&gt;&lt;/FONT&gt;&lt;/U&gt;&lt;/MARQUEE&gt;</textarea>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticewatermark_alpha');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    水印透明度:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticemarket_price_rate');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    市场价格比例:
        </td>
        <td>
          ...
          <span class="notice-span" style="display:block" id="noticemarket_price_rate">输入商品售价时将自动根据该比例计算市场价格</span>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticerewrite');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    URL重写:
        </td>
        <td>
          ...
          <span class="notice-span" style="display:block" id="noticerewrite">URL重写是一种搜索引擎优化技术，可以将动态的地址模拟成静态的HTML文件。需要Apache的支持。</span>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeintegral_name');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    消费积分名称:
        </td>
        <td>
          ...
          <span class="notice-span" style="display:block" id="noticeintegral_name">您可以将消费积分重新命名。例如：烧币</span>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeintegral_scale');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    积分换算比例:
        </td>
        <td>
          ...
          <span class="notice-span" style="display:block" id="noticeintegral_scale">每100积分可抵多少元现金</span>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeintegral_percent');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    积分支付比例:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticestats_code');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    统计代码:
        </td>
        <td>
          ...
          <span class="notice-span" style="display:block" id="noticestats_code">您可以将其他访问统计服务商提供的代码添加到每一个页面。</span>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticecache_time');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    缓存存活时间（秒）:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeenable_gzip');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    是否启用Gzip模式:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticecomment_factor');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    商品评论的条件:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticebgcolor');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    缩略图背景色:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticesend_mail_on');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    是否开启自动发送邮件:
        </td>
        <td>
        ...
        <table width="90%" id="display-table" style="display: none;">
                  <tbody><tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticesearch_keywords');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    首页搜索的关键字:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticecurrency_format');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    货币格式:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeimage_height');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    商品图片高度:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticecomments_number');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    评论数量:
        </td>
        <td>
          ...
          <span class="notice-span" style="display:block" id="noticecomments_number">显示在商品详情页的用户评论数量。</span>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticebought_goods');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    相关商品数量:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeattr_related_number');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    属性关联的商品数量:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticerecommend_order');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    推荐商品排序:
        </td>
        <td>
        ...
        <table width="90%" id="shopping_flow-table" style="display: none;">
                  <tbody><tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticecart_confirm');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    购物车确定提示:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeuse_how_oos');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    是否使用缺货处理:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticeinvoice_content');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    发票内容:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticemin_goods_amount');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    最小购物金额:
        </td>
        <td>
        ...
        <td>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticesend_service_email');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    下订单时是否给客服发邮件:
        </td>
        <td>
        ...
        <table width="90%" id="sms-table" style="display: none;">
                  <tbody><tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticesms_shop_mobile');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    商家的手机号码:
        </td>
        <td>
                    <input name="value[801]" type="text" value="" size="40"><a href="http://service.shopex.cn/sms/index.php?certificate_id=error&amp;sess_id=85f4c1184d3ed19a60bce32100e4335d&amp;auth=1497611598&amp;ac=899705f68e89271b06b844e5df675234" target="_blank">点此注册手机短信服务</a>
                              <br>
        ...
        <table width="90%" id="wap-table" style="display: none;">
                  <tbody><tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticewap_config');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    是否使用WAP功能:
        </td>
        <td>
          ...
          <span class="notice-span" style="display:block" id="noticewap_config">此功能只支持简体中文且只在中国大陆区有效</span>
                  ...
                  <tr>
        <td class="label" valign="top">
                    <a href="javascript:showNotice('noticewap_logo');" title="点击此处查看提示信息"><img src="../images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                    WAP LOGO上传:
        </td>
        <td>
...
<div id="footer">
共执行 5 个查询，用时 0.147962 秒，Gzip 已禁用，内存占用 2.116 MB<br>
