...
<title>ECSHOP 管理中心 - 开店向导－添加商品 </title>
...
<h1>
<span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 开店向导－添加商品 </span>
<div style="clear:both"></div>
</h1><div class="main-div">
<div class="step2">给商店添加一些商品<em>商品的名称、数量、分类、品牌、价格、描述等</em></div>
<form enctype="multipart/form-data" action="shophelp3.jsp" name="theForm" method="post" onsubmit="return validator()">
  <table cellspacing="1" cellpadding="3" width="100%">
    <tbody><tr>
      <td class="micro-label">商品分类:</td>
      <td><input type="text" name="good_category"></td>
    </tr>
    <tr>
      <td class="micro-label">商品名称:</td>
      <td><input type="text" name="good_name"></td>
    </tr>
    <tr>
      <td class="micro-label">商品数量:</td>
      <td><input type="text" name="good_number"></td>
    </tr>
    <tr>
      <td class="micro-label">商品品牌:</td>
      <td><input type="text" name="good_brand"></td>
    </tr>
    <tr>
      <td class="micro-label">商品价格:</td>
      <td><input type="text" name="good_price"></td>
    </tr>
    <tr>
      <td class="micro-label">加入推荐:</td>
      <td>
        <input type="checkbox" name="is_best" value="1" checked="">精品 
        <input type="checkbox" name="is_new" value="1" checked="">新品        <input type="checkbox" name="is_hot" value="1" checked="">热卖      </td>
    </tr>
    <tr>
      <td class="micro-label">商品描述:</td>
      <td><textarea name="good_brief" cols="40" rows="3" style="margin-top: 0px; margin-bottom: 0px; height: 145px;"></textarea></td>
    </tr>
    <tr>
      <td class="micro-label">上传商品图片:</td>
...
<div id="footer">
共执行 5 个查询，用时 0.099445 秒，Gzip 已禁用，内存占用 2.742 MB<br>
